...
const SingleCar = ({
  ...
  return (
    <div className="w-full max-w-[295px] h-[413px] rounded-[14px] border border-[#f1f1f1] shadow-lg mx-auto md:mx-0">
      <img
        src={image}
        alt={title}
      ...
      <div className="p-2">
        <div className="flex items-center justify-between">
          ...
          <p className="flex items-center gap-1.5">
            ...
            <span className="font-medium text-xs text-[#1d1d1d]">{rating}</span>
          </p>
        </div>
        <p className="font-normal text-xs text-[#5c5c5c] mt-1">Lorem ipsum dolor sit amet consectetur adipisicing.</p>
